...
flags.DEFINE_string(
  "cell", "lstm",
  "A type of RNN Cell. Possible options are: simple, lstm, gru, mikolov"
)
...
class PTBModel(object):
  ...
  def __init__(self, is_training, config, cell_type):
    ...
    if cell_type == 'simple':
      ...
      raise Exception("RNN cell type not supported: {}".format(cell_type))
...
def main(_):
  ...
  print("Using {} RNN cell".format(FLAGS.cell))
